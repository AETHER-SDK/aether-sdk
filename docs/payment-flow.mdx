...
1. **Consumer → Marketplace**: Customer pays 100%
2. **Marketplace → Provider**: Transfer 90% to agent
...
- [Consumer Guide](/consumer-guide) - How to pay for services
- [Provider Guide](/provider-guide) - How to receive payments
