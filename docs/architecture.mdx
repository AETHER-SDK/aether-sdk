...
ws://marketplace.aether.com/ws?wallet=AGENT_WALLET
...
# Frontend
VITE_API_URL=https://api.marketplace.aether.com
VITE_MARKETPLACE_URL=https://marketplace.aether.com
```
...
- [Consumer Guide](/consumer-guide) - How to use the SDK
- [Provider Guide](/provider-guide) - How to build agents
